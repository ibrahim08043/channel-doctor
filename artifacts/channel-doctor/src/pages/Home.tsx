              ...
              <motion.div key={c.id} variants={fadeUp}>
                <Link href={`/channel/${c.id}`}>
                  <Card className="group flex h-full items-start gap-4 p-4 glass transition-all hover:border-primary/40 hover:glow-primary hover-elevate cursor-pointer">
                    <img src={c.thumbnail} alt={c.title} className="h-14 w-14 shrink-0 rounded-full border border-white/10 object-cover" />
        ...
        {isLoading || !data ? (
          ...
          <>
            <div className="flex items-center gap-3">
              <img src={data.thumbnail} alt="" className="h-12 w-12 rounded-full ring-2 ring-primary/30" />
